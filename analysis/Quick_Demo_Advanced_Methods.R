...
# Resolve repo path and load methods
...
source(file.path(repo_root, "analysis", "Advanced_Pooling_Methods.R"))
...
if (require("Pairwise70", quietly = TRUE) ||
    tryCatch({
      if (!requireNamespace("devtools", quietly = TRUE)) stop("devtools missing")
